...
<!-- These docs were automatically generated from the LifterLMS-Modern/ruleset.xml file on 2022-09-21T00:10:11Z. -->

## Contents

<ol>
  <li>[Overview](#1-overview)</li>
  <li>[General](#2-general)
    <ol>
      <li>[Basic Coding Standard](#21-basic-coding-standard)</li>
    </ol>
  </li>
</ol>
   2.2. [Files](#22-files)
